...
struct AddAngelComponent: View {
    ...
    @State private var discontinued: Bool = false

    @State private var showPicSheet: Bool = false
    @State private var showImagePicker: Bool = false
    @State private var sourceType: UIImagePickerController.SourceType = .camera
    @State private var image: UIImage?
    @State private var color: String = "Braun"
    ...
    init(_ angel: Angel? = nil) {
        ...
        _itemNr = State(initialValue: angel?.itemNrWrapped ?? "")
        ...
        _color = State(initialValue: angel?.colorWrapped ?? "")
